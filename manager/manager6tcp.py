...
class ManageBridge:
    ...
    def __init__(self):
        ...
        try:
            ...
            print ModuleName, "Warning. Need to run discovery before start"
            self.bridgeID = 42
            self.friendlyName = "Locally Friendly Bridge"
            self.apps = {"app1": 
                   {"name": "living",
                    "version": 1,
                    "exe": "/home/pi/bridge/apps/living2.py",
    ...
    def startAll(self):
        ...
        for adaptor in self.adts:
            try:
                ...
                adtSoc = self.adts[adaptor]["adtSocs"][0]
                subprocess.Popen([exe, btAdpt, btAddr, mgrSoc, adtSoc])
