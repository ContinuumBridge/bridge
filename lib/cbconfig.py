...
if os.environ.get('CB_BRIDGE_KEY='):
...
elif os.path.exists(CB_CONFIG_DIR + "thisbridge.py"):
    CB_SIM_LEVEL = '0'
    CB_NO_CLOUD = False
    CB_CONTROLLER_ADDR = '54.194.28.63'
    CB_BRIDGE_EMAIL = 'noanemail'
    CB_BRIDGE_PASSWORD = 'notapassword'
    CB_LOGGING_LEVEL = 'DEBUG'
    CB_LOGFILE = CB_SNAPPY_DIR + '/cbridge.log'
    CB_DEV_BRIDGE = False
    CB_DEV_UPGRADE = False
    CB_WLAN_TEST = False
    CB_GET_SSID_TIMEOUT = '600'
    CB_ZWAVE_BRIDGE = False
    CB_ZWAVE_PASSWORD = 'admin'
    CB_CELLULAR_BRIDGE = False
    CB_PERIPHERALS = 'none'
    CB_DEV_APPS = 'none'
    CB_DEV_ADAPTORS = 'none'
    CB_USERNAME = 'none'
    CB_BID = 'unconfigured'
    CB_CELLULAR_PRIORITY = False
    CB_RASPBERRY = True
    execfile(CB_CONFIG_DIR + "thisbridge.py")
else:
    print("Warning, no CB environment variables and no thisbridge.py file")
